...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("ninjaMuffin", "PixelDayPCGame", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "PixelDayPCGame";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "PixelDayPCGame", null, { width: 960, height: 720 });
